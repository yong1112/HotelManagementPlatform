...
<html>
    ...
    <%
        ...
        Staff cust = (Staff) session.getAttribute("staff");
    ...
    <body onload="passwordCheck()">
        <div class="ui middle aligned grid" 
            ...
            <div class="column">
                ...
                <form class="ui form segment" action="/hotelmanagement/L111_ManagerStaffConfirm" method="post">
                    ...
                    <div class="two fields" style="margin-left: 1px">
                        ...
                        <button type="button" onClick="toManagerAccountsList()" class="ui medium button">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
