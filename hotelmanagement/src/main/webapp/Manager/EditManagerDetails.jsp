    ...
    <body onload="passwordCheck()">
        <div class="ui middle aligned grid" 
            ...
            <div class="column">
                ...
                <form class="ui form segment" action="/hotelmanagement/L105_ManagerEditDetails" method="post">
                    <div class="two fields">
                        <div class="field">
                            <label>First name</label>
                            <input value="${user.firstName}" autocomplete="off" required name="firstName" type="text">
                        </div>
                        <div class="field">
                            <label>Last name</label>
                            <input value="${user.lastName}" autocomplete="off" required name="lastName" type="text">
                        </div>
                    </div>
                    <div class="field">
                        <label>Old Email</label>
                        <input value="${user.username}" autocomplete="off" required name="oldEmail" type="email" readonly>
                        <p id="existingEmail"></p>      
                    </div>
                    <div class="field">
                        <label>Password</label>
                        <input value="${user.password}" placeholder="Enter password" autocomplete="off" required name="password" type="password">
                    </div>
                    <div class="field">
                    ...
                    <div class="two fields" style="margin-left: 1px">
                        ...
                        <button type="button" onClick="ToManagerAccount()" class="ui medium button">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
