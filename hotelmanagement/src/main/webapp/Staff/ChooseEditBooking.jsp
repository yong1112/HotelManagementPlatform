...
<html>
    ...
    <body onload="checkLogin()">
        ...
        <div style="margin-top: 10px; margin-left: 50px; margin-bottom: 20px;">
            <!-- Site content !-->
            <h1 class="ui header">Edit a Booking</h1>
        ...
        <div style="margin-top: 20px; margin-left: 150px; margin-right:150px">
            <form action="/hotelmanagement/C404_ChooseEditBooking" method="POST">
                <table id ="table" class="ui large celled striped table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><button type="submit" class="ui blue button" name="bookingID" value="<%=allBooking.get(i)%>">Edit</button></td>                        
                            <%}%>
                    </tbody>
                </table>
            </form>
