...
<html>
    ...
    <%
        ...
        Staff m = (Staff) session.getAttribute("manager");
    ...
    <body onload="passwordCheck()">
        <div class="ui middle aligned grid" 
            ...
            <div class="column">
                ...
                <form class="ui form segment" action="/hotelmanagement/L118_AdminManConfirm" method="post">
                    <div class="two fields">
                        <div class="field">
                            <label>First name</label>
                            <input value="<%=m.getFirstName()%>" autocomplete="off" required name="firstName" type="text">
                        </div>
                        <div class="field">
                            <label>Last name</label>
                            <input value="<%=m.getLastName()%>" autocomplete="off" required name="lastName" type="text">
                        </div>
                    </div>
                    <div class="field">
                        <label>Old Email</label>
                        <input value="<%=m.getUsername()%>" autocomplete="off" required name="oldEmail" type="email" readonly>
                        <p id="existingEmail"></p>
                    </div>
                    <div class="field">
                        <label>Password</label>
                        <input value="<%=m.getPassword()%>" placeholder="Enter password" autocomplete="off" required name="password" type="password">
                    </div>
                    <div class="field">
                    ...
                    <div class="two fields" style="margin-left: 1px">
                        ...
                        <button type="button" onClick="toAdminAccountsList()" class="ui medium button">Cancel</button>
                    </div>
                </form>
            </div>
        </div>
