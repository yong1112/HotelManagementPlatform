    ...
    <body onload="passwordCheck()" > 
        <div class="ui middle aligned grid" 
            ...
            <div class="column">
                ...
                <form class="ui form segment" action="/hotelmanagement/L101_EditDetails" method="post">
                    ...
                    <div class="two fields" style="margin-left: 1px">
                        ...
                        <button type="button" onClick="ToCustomerAccount()" class="ui medium button">Cancel</button>
                </form>
            </div>
        </div>
    </div>
