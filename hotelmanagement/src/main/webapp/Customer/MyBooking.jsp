...
<html>
    ...
    <body onload="registerCheck()">
        ...
        <div style="margin-top: 10px; margin-left: 50px; margin-bottom: 50px;">
            <!-- Site content !-->
            <h1 class="ui header">Booking History</h1>
            <a onClick="ToCancelMyBooking()" class="ui blue button" style="margin-right: 10px">Cancel a booking</a>
        </div>
            ...
            <div style="margin-left: 300px; margin-right:300px">
                <table class="ui celled table">
                    ...
                    <form action="/hotelmanagement/C502_CustomerRequest" method="GET">   
                        <td>
                            <button class ="ui blue button" type="submit" name="Btn" value="<%=myBooking.get(i)%>">Request</button>
                        </td>
                    </form>
