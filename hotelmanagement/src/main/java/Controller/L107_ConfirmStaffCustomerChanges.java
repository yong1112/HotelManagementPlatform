 ...
 * @author csw
 */
@WebServlet(name = "L107_ConfirmStaffCustomerChanges", urlPatterns = {"/L107_ConfirmStaffCustomerChanges"})
public class L107_ConfirmStaffCustomerChanges extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if(password.equals(confirmPassword)){
                ...
                response.sendRedirect("/hotelmanagement/Staff/StaffViewAccounts.jsp");
            }
            else {
                session.setAttribute("passwordError", "Passwords do not match.");
                response.sendRedirect("/hotelmanagement/Staff/StaffEditCustomerDetails.jsp");
            }
