 ...
 * @author csw
 */
@WebServlet(name = "L116_AdminStaffConfirm", urlPatterns = {"/L116_AdminStaffConfirm"})
public class L116_AdminStaffConfirm extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            if(password.equals(confirmPassword)){
                ...
                response.sendRedirect("/hotelmanagement/Admin/AdminViewAccounts.jsp");
            }
            else {
